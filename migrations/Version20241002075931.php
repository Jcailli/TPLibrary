 ...
 */
final class Version20241002075931 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE borrowing (id INT AUTO_INCREMENT NOT NULL, book_version_id INT DEFAULT NULL, user_id INT DEFAULT NULL, borrowing_date DATE NOT NULL, return_date DATE DEFAULT NULL, returned TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_226E5897D4116DB6 (book_version_id), INDEX IDX_226E5897A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, book_version_id INT DEFAULT NULL, user_id INT NOT NULL, is_active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_42C84955D4116DB6 (book_version_id), INDEX IDX_42C84955A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
